...
<div className="text-center pb-6" style={{ maxWidth: "500px", margin: "0 auto" }}>
      {/* <p className="text-[#D81324] flex justify-center text-lg font-semibold uppercase  inline-block py-1 rounded pt-3 sm:pt-0 sm:mb-2 flex items-center">
...
+88-02-222285360, +88-02-222295013</span>
        </div>
      </div>
      <div className="flex border-b-0 pb-3 mb-3">
        <div className="flex-shrink-0  rounded-full p-4">
          <IoCellular    className="text-red-600" />
        </div>
        <div className="ml-3">
          <h6 className="font-bold text-[#000]">Cell</h6>
          <span className="text-[#596277]"> 

          01716-537772,01616-537772</span>
        </div>
      </div>
      <div className="flex border-b-0 pb-3 mb-3">
        <div className="flex-shrink-0  rounded-full p-4">
...
/>
    ...
    <form>
      ...
      {/* Submit Button */}
      <button className="w-full uppercase mt-6 bg-[#D81324] text-white  py-3 px-5   transition-colors duration-300">
        Send Message
      </button>
    </form>
  </div>
