                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <div>
                            ...
                            <div className="flex pt-2">
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#D81324] hover:bg-white" href=""><FaTwitter /></a>
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#D81324] hover:bg-white" href=""><FaFacebookF /></a>
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#D81324] hover:bg-white" href=""><FaYoutube /></a>
                                <a className='border border-white p-2 rounded-full hover:text-[#D81324] hover:bg-white' href=""><FaLinkedinIn /></a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative mx-auto" style={{ maxWidth: '400px' }}>
                                ...
                                <button type="button" className="absolute top-0 right-0 mr-2 bg-[#D81324] text-white mt-2  py-2 px-4 uppercase">SignUp</button>
                            </div>
                        </div>
                    </div>
                </div>
