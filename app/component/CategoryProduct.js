...
//     <div class="py-4 px-4 mx-auto max-w-9xl sm:py-4 sm:px-14">
...
//             <h3 class="z-10 text-2xl font-medium text-white w-44   absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">Wines</h3>
//           </a>
//         </div>
